...
## ------------------------------------------------------------------------------------------------------------------
df <- read.csv("../data/vowel.dat", comment.char="@", header = FALSE)
...
## ------------------------------------------------------------------------------------------------------------------
str(df) # observe dataset variables
...
## ------------------------------------------------------------------------------------------------------------------
# Bivariate plots
# Boxplots of formants by vowel class
...
## ------------------------------------------------------------------------------------------------------------------
# Scatterplot F1 vs F2 by vowel class
...
## ------------------------------------------------------------------------------------------------------------------
# Violin plots to examine sex influence on formants
